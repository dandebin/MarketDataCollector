...
namespace DemoTrader
{
    ...
    class testTraderApi
    {
        ...
        */
        string FRONT_ADDR = "tcp://101.226.255.233:61715"; // "tcp://asp-sim2-md1.financial-trading-platform.com:26213";  // 前置地址
        string BROKER_ID = "99999"; // "2030";                       // 经纪公司代码
        string INVESTOR_ID = "18011006110"; // "888888";                       // 投资者代码
        string PASSWORD = "131739"; // "888888";                     // 用户密码
        string INSTRUMENT_ID = "510050";
        EnumDirectionType DIRECTION = EnumDirectionType.Buy;
        double LIMIT_PRICE = 2.2;
        int iRequestID = 0;
